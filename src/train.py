...
# rtm1 = ReverseTechurModel1 = English to Techur
# tm1 = TechurModel1 = Techur to English
...
# This is for ReverseTechurModel1, which is English to Techur #
# tokenize data set
dataset = load_dataset('json', data_files='reverse_data.json')
tokenized_dataset = dataset.map(tokenize, batched=True)
...
#train and save the model as tm1 (TechurModel1)
trainer.train()
model.save_pretrained("rtm1")
tokenizer.save_pretrained("rtm1")